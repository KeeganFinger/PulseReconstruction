...
complex<double> ErrorFunction(complex<double> z, double a) {
    if (abs(z + 2.*I) < 1.1) {
        z += 2.*I;
        return exp(a) *
               (-18.564802*I + 12.326185 * z + 13.9957261*I * z * z - 7.0912286 * z * z * z - 2.1539997*I * z * z * z * z +
                0.80057144 * z * z * z * z * z) /
               (1.0 - 2.6545518*I * z - 2.9260194 * z * z + 1.665267*I * z * z * z + 0.48178231 * z * z * z * z -
                0.054052386*I * z * z * z * z * z);
    } else if (abs(z - 2.*I) < 1.1) {
        z -= 2.*I;
        return exp(a) *
               (18.564802*I + 12.326185 * z - 13.9957261*I * z * z - 7.0912286 * z * z * z + 2.1539997*I * z * z * z * z +
                0.80057144 * z * z * z * z * z) /
